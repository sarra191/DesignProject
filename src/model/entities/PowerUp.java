...
public class PowerUp extends Entity {
    ...
    private static Graphics2D staticG2D = null;  // on stocke le Graphics du paintComponent
    ...
    // Méthode appelée une seule fois par frame depuis GamePanel
    public static void setGraphics(Graphics2D g) {
        staticG2D = g;
    }

    @Override
    public void render() {                     // exactement la signature demandée par Entity
        if (!active || staticG2D == null) return;
